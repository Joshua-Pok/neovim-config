    ...
    local servers = {
      ...
      pyright = {
        settings = {
          python = {
            analysis = {
              autoImportCompletions = true, -- Enable auto-imports for Python
      ...
      -- For TypeScript/JavaScript - enhanced configuration
      ts_ls = {
        settings = {
          typescript = {
            inlayHints = {
            ...
            suggest = {
              includeCompletionsForModuleExports = true, -- Enable auto-imports
              autoImports = true,
            },
            preferences = {
